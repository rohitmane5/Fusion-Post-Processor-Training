...
//     break;
//   default:
//     error(subst(localize("Invalid feerdate mode: %1"), mode));
//   }
// }
...
function writeDrillCycle(cycle, x, y, z) {
  ...
  if (isFirstCyclePoint()) {
    ...
    writeBlock(gFeedModeModal.format(getProperty("useG95") || (isTappingCycle() && getProperty("usePitchForTapping")) || (!isTappingCycle() && currentSection.feedMode == FEED_PER_REVOLUTION) ? 95 : 94));
...
// <<<<< INCLUDED FROM include_files/setProbeAngleMethod.cpi
// >>>>> INCLUDED FROM ../Include_Files/Common.cpi
function TestMerge() {
  writeBlock("TestMerge", "This is a test of the merge function.");
}
// <<<<< INCLUDED FROM ../Include_Files/Common.cpi
// include("C:/Users/maner/AppData/Roaming/Autodesk/Fusion 360 CAM/Posts/Training/Include_Files/Common.cpi");
